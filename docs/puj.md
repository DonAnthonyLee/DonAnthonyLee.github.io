...
<br>
**关于白话字用字规则补充（缺省作者按）：**
1. 此专栏中所写白话字文除 -n/-t 韵尾采用半复古方式外，所有（译文除外）均为个人平日腔调，所不同者为部分 -n/-t 韵尾读为 -ng/-k； <br>
2. 译文之类为综合原作及部分他处说法有选择性地采用用词与用音；<br>
3. -n/-t 韵尾标注规则，主要以白话字词典及《潮汕十五音》为准，其次为个人故乡所听到者，最后为参考同源的闽南漳泉腔等；对于与词典等不符者，极个别在源文件中采用就近注写进行说明；当然，个别词语出错在所难免，若有保留此等韵尾稍为完善之地（凤凰、三饶等地）乡亲愿提供资料，可直接联系本人；<br>
4. 转换规则列举：府城口音者，-io- 变 -ie-；-ian 变 -ieng；-iat 变 -iek；-uan 变 -ueng（极个别除外）；-uat 变 -uek；-iau- 变 -iou-；其他 -n/-t 韵尾均改为 -ng/-k 韵尾。至于其他地方，请参考前述自行转换，不再赘述。
<br>
