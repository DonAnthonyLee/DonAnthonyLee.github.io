...
4. 转换规则列举：府城口音者，-io- 变 -ie-；-iau- 变 -iou-；-ian 变 -ieng（极个别除外）；-iat 变 -iek；-uan 变 -ueng（极个别除外）；-uat 变 -uek；无 -uam/-uap/-om/-op 者相应变为 -uang/-uak/-am/-ap 等；其他 -n/-t 韵尾均改为 -ng/-k 韵尾。至于其他地方口音者，请参考前述自行转换，不便于此赘述。
<br>
